...
no real dry (zero-flood) CAR scenario available yet, so the min-total-water-
depth stand-in is used until one exists (see data_car.save_pseudo_dry_baseline's
docstring). Swap to save_dry_baseline() once a genuine CAR dry-run scenario
is available.
"""
