...
the dynamic dataset and the real dry baseline.
...
Uses save_dry_baseline() - a real dry-run CAR scenario is now available
(Copenhagen_acc_raindist_samples_BASELINE_CAR.pkl), so the old min-total-water-
