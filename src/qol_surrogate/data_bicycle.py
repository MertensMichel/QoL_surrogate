...
def save_pseudo_dry_baseline(taz_acc, output_dir=DRY_BASELINE_DIR):
    ...
    CURRENTLY USED - there's no real dry (zero-flood) BICYCLE scenario available yet
    ...
    a genuine dry-run BICYCLE scenario is available; it's kept here unused for now.
    """
    os.makedirs(output_dir, exist_ok=True)
...
def save_dry_baseline(hexes, taz_ids, baseline_file=BASELINE_FILE, output_dir=DRY_BASELINE_DIR,
    ...
    (save_pseudo_dry_baseline() above) once a real dry-run sample exists for BICYCLE.
